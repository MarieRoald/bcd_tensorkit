...
OUTPUT_PATH = Path("201120_noise_05_20_30_40_SPARSE-0-01")
...
def run_double_experiment(dataset_num, X, rank):
    ...
    pf2 = double_splitting_parafac2.BlockEvolvingTensor(
        rank,
        sub_problems=[
            double_splitting_parafac2.Mode0ADMM(l1_penalty=L1_PENALTY, non_negativity=True, max_its=INNER_SUB_ITS, tol=INNER_TOL),
...
def run_single_C_experiment(dataset_num, X, rank):
    ...
    pf2 = block_parafac2.BlockParafac2(
        rank,
        sub_problems=[
            block_parafac2.ADMM(mode=0, l1_penalty=L1_PENALTY, non_negativity=True, max_its=INNER_SUB_ITS, tol=INNER_TOL),
